...
import com.mytlx.compiler.mysyntax.symbols.NonTerminal;
import com.mytlx.compiler.mysyntax.symbols.Terminal;
import com.mytlx.compiler.mysyntax.tree.SyntaxTree;
                ...
                case "FormList":
                    ...
                    for (String varName : varNames) {
                        if (currentScope.contains(varName)) {
                            ...
                            log.add('[' + dateFormat.format(new Date()) + "] [ERROR] Duplicate variable definition: " + node.getText());
                        } else {
                ...
                case "Stm":
                    ...
                    for (String var : vars) {
                        if (!currentScope.containsRecursive(var)) {
                            ...
                            log.add('[' + dateFormat.format(new Date()) + "] [ERROR] Undefined variable: " + node.getText());
                        }
                    }
                default:
                    traverse(node.getChildren(), currentScope);
